    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <ul class="nav navbar-nav navbar-right">
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i> <?php echo $userRow['patientFirstName']; ?> <?php echo $userRow['patientLastName']; ?>
                        <b class="caret"></b></a>
                ...
                <div class="col-md-3 col-sm-3">
                    <div class="user-wrapper">
                        ...
                        <div class="description">
                            ...
                            <hr/>
                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal">Actualizar
                                Perfil
                            </button>
                        </div>
                    </div>
                                ...
                                <form class="form" role="form" method="POST" accept-charset="UTF-8">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="symptom"
                                               pattern="[A-Za-z\s]+" title="Ingrese solo texto" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="message-text" class="control-label">Comentarios: </label>
                                        <textarea class="form-control" name="comment" pattern="[A-Za-z\s]+"
                                                  title="Ingrese solo texto" required></textarea>
                                    </div>
                                    <div class="form-group">
                                        <input type="submit" name="appointment" id="submit" class="btn btn-primary"
                                               value="Agende su cita!">
                                    </div>
